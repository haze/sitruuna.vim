" sitruuna-blue.vim
" A fresh blue lemon inspired colorscheme for vim
...
set background=dark
let g:colors_name="sitruuna-blue"
" }}}
" Colors {{{
let s:col              = {}
let s:col.lemon        = ['#95ADD0', 220]
let s:col.bright_lemon = ['#bfcde2', 220]
let s:col.special      = ['#a9ffd9', 215]
